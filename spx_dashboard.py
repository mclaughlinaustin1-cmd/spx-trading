# =========================================================
# SPX INTRADAY TRADING SIGNAL DASHBOARD (RULE-BASED)
# =========================================================
...
st.title("📊 SPX Intraday Trade Signal Engine (15-Minute Horizon)")
...
# ---------------------------------------------------------
# DO NOT TRADE CONDITIONS (HARD STOPS)
# ---------------------------------------------------------
do_not_trade = False
do_not_trade_reason = ""
...
# Trade Plan Display
# ---------------------------------------------------------
st.subheader("📍 Trade Levels (15-Minute Horizon)")
st.markdown(f"""
- **Entry:** {entry:.2f}  
- **Target:** {target:.2f}  
- **Invalidation:** {invalidation:.2f}  
- **Risk Type:** Defined (ATR-based)  
""")
...
st.caption(
    ...
    "Rule-based signals. Educational / informational use."
)
